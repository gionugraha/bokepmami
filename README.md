...
A live demo of the project is available at [https://bokepmami.pages.dev](https://bokepmami.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep mami`)
...
1. Fork the [repository](https://github.com/gionugraha/bokepmami/fork) on GitHub.
